...
Por lo tanto para que desaparezca el _warning_ si teníamos instalada la versión 8 del JDK editamreos en Eclipse el fichero pom.xml cambiando los dos valores anteriores a `1.8`.

...
Hasta aquí el segundo Post, que no es poco. Con el entorno montado ahora ya estamos en disposición de crear la pequeña aplicación que nos sirva como base para ensayar con cualquier tecnología o herramienta que nos interese, Java EE o no, e iniciar así un recorrido en el que vayamos ganando destreza como desarrolladores a través de la lectura y de la práctica. ¿Qué podría hacer nuestra pequeña aplicación? !Pues casi lo que se nos ocurra! Mostrar listas maquetadas con datos extraidos de una base de datos o solicitados a un servicio web de un tercero o implementado por nosotros mismos y desplegado en nuestro propio servidor u otro distinto. Que más, imprimir estas listas o hacer informes estadísticos de los datos y guardarlos en formato PDF o enviarlos por email a varios destinatarios, etc, etc. Todo esto iremos viéndolo en futuros Posts. Y todo esto no es muy diferente a lo que se maneja en un proyecto empresarial real en cualquier empresa. Hasta pronto!

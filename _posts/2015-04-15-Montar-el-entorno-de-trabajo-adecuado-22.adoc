...
Y ya podamos controlar nuestro servidor desde Eclipse! Si nos vamos a la pestaña Servidores vemos que ahora existe un icono para el servidor y si lo expandimos observamos que nuestra aplicación está allí enlazada. Ahora arrancamos simplemente pulsando sobre el icono del servidor con el botón derecho y seleccionando la opción _Start_.

image::https://raw.githubusercontent.com/lametaweb/lametaweb.github.io/master/images/001/prac001-fig105.png[]

Además en la pestaña _Console_ podremos ver los mensajes de salida del servidor fechados y con información del módulo que lo genera. Para ello hacemos botón derecho de nuevo sobre el servidor y seleccionamos Show In &gt; Console. Si le echamos un vistazo podemos ver los diferentes mensajes del inicio del servidor, entre ellos por ejmplo el de la carga del módulo de Weld CDI que usa nuestra pequeña aplicación de prueba.

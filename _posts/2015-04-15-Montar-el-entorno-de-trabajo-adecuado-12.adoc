...
WARNING: En la lista de aplicaciones instaladas no aparecen de forma explícita los JDKs de terceros Poner mucho cuidado  cuando desinstalemos JDKs antes de instalar una nueva versión. Hacerlo sólo cuando estemos seguros de que no afectará a aplicaciones de terceros. Un JDK de tercero se identifica porque se encuentra en la carpeta de la aplicación que lo instaló. 

...
NOTE: Si el contenido del archivo pom.xml se muestra en Eclipse como un formulario es posible que tengamos que ir a la opción _Window > Preferences > Maven > User Interface_ y desmarcar el check para la opción _Open XML page in the POM editor by default_.

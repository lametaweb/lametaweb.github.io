...
Antes de nada vamos a añadir a nuestro proyecto la dependencia del proveedor de persistencia Hibernate para poder implementar y compilar las entidades. Hasta este momento habíamos definido ninguna dependecia. En primer lugar añadimos este fragmento XML bajo el elemento <project>:

...
La página es creada y Eclipse nos la mostrará en el editor por defecto lista para que empecemos a componerla. De momento pulsamos sobre la lengüeta _Source_ para tener acceso a un código xhtml como éste:

...
* session-config: Engloba las propiedades de configuración de la sesión http en el servidor. Aquí definimos en tiempo máximo que el usuario puede dejar de interactuar con la aplicación antes de que su sesión sea descartada.

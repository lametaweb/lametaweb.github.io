...
war que se genera y despliega en el servidor sea el id del artefacto, en nuestro caso "jdrone". Esto es conveniente ya que por defecto
el nombre del contexto de nuestra aplicación web es tomado del nombre del war y en caso de no incluir esta información la ruta URL de nuestra
aplicación no se simplificaría.

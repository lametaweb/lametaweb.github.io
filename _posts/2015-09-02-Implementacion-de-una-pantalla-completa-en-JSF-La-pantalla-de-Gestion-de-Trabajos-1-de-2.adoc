...
Viendo la simplicidad y limpieza del código nos damos cuenta de la potencia de JSF y de sus múltiples ventajas frente a frameworks MVC basados en la petición Y hasta aquí los aspectos más importantes de la página de maestro.

...
Se tienen tres puntos de definición de contenido, _central_, donde se ha añadido el contenido de la página antigua,_menu_, donde incluiremos un menú como veremos a continuación, y _logo_ para el logo de la aplicación y de la empresa. 

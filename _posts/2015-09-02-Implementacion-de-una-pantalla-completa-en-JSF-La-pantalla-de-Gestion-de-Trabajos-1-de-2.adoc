...
Por otro lado tenemos las páginas públicas de la aplicación, que van a usar la plantilla incluyendo el contenido variable mediante la inclusión de elementos _<ui:define...>_. Básicamente una página tendrá este aspecto:

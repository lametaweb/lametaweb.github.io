...
Aquí es donde está como se suele decir "la chicha" de un mantenimiento de entidad. La complejidad dependerá como ya sabemos del número y tipo de relaciones de la entidad gestionada.

...
. Finalmente una vez que el framework ha creado la View con todos los componentes y los valores correspondientes la página es renderizada como XHTML y enviada al usuario.

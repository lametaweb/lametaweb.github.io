...
Para comprobar que JSF 2.2 funciona correctamente realicemos unas sencillas modificaciones sobre nuestra página _index.xhtml_:

. Actualizamos a HTML5. Para ello actualizad el doctype de la página así:

	<!DOCTYPE html>

. Nos adaptación a JSF 2.2 cambiando los espacios de nombres:

	<html xmlns="http://www.w3.org/1999/xhtml"
	xmlns:h="http://xmlns.jcp.org/jsf/html"
	xmlns:f="http://xmlns.jcp.org/jsf/core">

. Añadimos un elemento nuevo de JSF 2.2 para comnprobar si el cambio de versión ha sido efectivo. Sustituimos la línea de código primera por la segunda:

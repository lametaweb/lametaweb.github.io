...
Hasta aquí el despliegue automatizado con Maven. Veamos el mismo despliegue realizado de forma manual. La manera en que se instalan los recursos es diferente desde la versión 6 de JBoss, y se basa en módulos.
...
Lo que hace nuestro método cargaDeDatos es dar de alta en la base de datos un Trabajo con una ruta determinada y un Drone que es el que se programa para realizar ese trabajo. Como veis en todo momento trabajo con los objetos de la capa de datos y la base de datos queda oculta por JPA. Vamos a ver un poco más en detalle el código desde el principio, es conveniente que tengáis delante el diagrama de diseño que vimos en el post anterior para entender mejor las operaciones:

* Tenemos que crear la jerarquía de objetos que deseamos persistir, dar valor a los atributos de cada objeto y finalmente establecer las relaciones entre ellos.

* Empezamos creando los objetos PuntaRuta de la ruta para el Trabajo. Creamos cada uno de los objetos y damos valor a los atributos. Se define una ruta triangular cerrada siendo el punto inicial y final por tanto el mismo. Podéis verla en la siguiente figura:

++++
<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d6341.548136844798!2d-5.9974985!3d37.3715225!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2ses!4v1434039908896" width="400" height="300" frameborder="0" style="border:0"></iframe>
++++

* A continuación se crea el objeto Trabajo y se inicializan sus atributos. Para el intervalo de comienzo y finalización del trabajo se calcula una hora hacia atrás y una hacia delante respecto del momento en que iniciamos la aplicación. Esto lo hago simplemente para que en la aplicación se muestre este drone introduciendo una fecha y hora que correspondan a ese momento.

* Explicar EL ESTADO DE LOS OBJETOS Y LA TRANS INICIADA.
...
En este punto tenemos una aplicación web publicada. Si abrimos un navegador y vamos a la dirección `http://localhost:8080/jboss-helloworld` sabremos que todo ha ido bien si nos muestra el conocido mensaje `Hello World!`.

...
|[small]#La ruta se introducirá manualmente sobre un grid presentado en pantalla.#
|[small]#Se verificará la corrección de los datos introducidos en el grid de puntos de ruta.#
|===
